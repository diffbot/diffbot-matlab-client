Diffbot is a simple function that can be used to get the json response of any url provided with parameters



Run  the file RunDemo.m , shows step by step usage for Functions
...
INSTALLATIOPON : Just Select the Current Working Directory in MATLAB and RUN RunDemo
...
See RunDemo.m for a demo of usage
...
-----------------------------------------------------------------------
 ...
 fields = Used to control which fields are returned by the API see Options below example 
 example
...
Output  Argument:
-----------------------------------------------------------------------
 ret = A response from Diffbot API in JSON Format


Example 1 (Usage DiffbOT):
...
diffbot('http://www.xconomy.com/san-francisco/2012/07/25/diffbot-is-using-computer-vision-to-reinvent-the-semantic-web/','DIFFBOT_TOKEN','analyze',{'title','images(*)'},'2');
