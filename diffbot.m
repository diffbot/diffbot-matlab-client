function ret =diffbot(url, token, api, fields,version)
...
% Author Abdullah K. ,abdkhan@hotmail.com
...
% Define API Address on diffbot
API_URL='http://api.diffbot.com/v2/article?';


% Recounstrcting String Field
    field=fields{1};
    
    for i=2:length(fields)
       field=strcat(field,',',fields{i});
    end
    
% Full String .......


URL=strcat(API_URL,'token=',token,'&url=',url,'&api=',api,'&fields=',field,'&version=',version);
ret = urlread(URL);
